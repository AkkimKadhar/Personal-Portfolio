...
const Testimonial = () => {
  const clients = [
    ...
    },
    {
      img: profilePic4,
      review:
        "ishu Simple enough to learn quickly and get around easily, complicated enough to get really organized and track a lot of info. Love the visually simple design. And love the collaboration possible with clients",
    },
  ];
